...
def main(is_simple_data:bool = True):
    ...
    if plan_selection == '1':
        model, eps, X_train, y_train, scaler = train_model(embed_data, id_data, date_data, location_data, user_selection='multi-output')
    else:
        model, eps, X_train, y_train, scaler = train_model(embed_data, id_data, date_data, location_data, user_selection='multi-input')
